...
Axion-photon coupling: $g_{aγ} < \SI{6.6e-11}{\GeV^{-1}}$ \cite{cast_nature}
Axion-electron coupling, given as combined coupling with $g_{aγ}$: 
$g_{ae} g_{aγ} < \SI{8.1e-23}{\GeV^{-1}}$ *CITE 2013* 

Chameleon limit: $β_γ < \num{5.74e10}$ *CITE KRIEGER*
