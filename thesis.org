...
property. This raises the important question of what defines such a
...
- [ ] *PUT THE COMMENT BELOW HERE BACK INTO TEXT, BUT TO WHERE IT
  LATER FITS PROPERLY, AS CURRENTLY THE ABOVE IS MOSTLY AN
  INTRODUCTION MOTIVATING THE NEED FOR CDL DATA*
#+begin_comment
...
:PROPERTIES:
:CUSTOM_ID: sec:morphing_cdl_spectra
:END:
