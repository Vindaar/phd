...
- [ ] *ADD EXPLANATION HOW IT FITS INTO ~raw_data_manipulation~ AND ~reconstruction~*
...
- [ ] alignment photo of laser alignment
- [ ] geometer measurements
- [ ] X-ray finger for alignment
...
- Installation for data taking start ::    
  ...
  - <2017-09-14> Alignment with geometers for data taking 
...
- Reinstallation for data taking start (Run 2) ::
  ...
  - <2017-10-26 Thu> Alignment with Geometers (after removal &
    remounting due to window accident) for data taking
...
- Reinstallation for data taking in Oct 2018 (Run 3) ::
  ...
  - <2018-07-23 Mon> Alignment with Geometers for data taking
...
EDMS links under \cite{geometer_1,geometer_2,geometer_3,geometer_4}
...
beamline area. The lead shielding is a *HOW MANY CM* thick castle of
lead around the detector. An image is seen in fig. *INSERT ME*.
...
- [ ] *INSERT THE PDF OF THE LEAD SHIELDING!
...
During the preparations of the detector for data taking, it
became clear that the rubber seals of the quick connectors used for
the water cooling system started to disintegrate. The connectors were
replaced by Swagelok connectors, but the water cooling system still
contained rubber pieces blocking the flow. Due to the small diameter
and twisted layout of the cooling pipes in the copper body, the only
way at hand to clean them was a compressed air line, normally used for
operation of the $\ce{^{55}Fe}$ manipulator
...
See timeline for overview of important points to cover.
...
- [ ] *MENTION 2016 COSMIC ALIGNMENT MEASUREMENT?*



** Detector installation March 2017
...
*** FADC noise [/]
:PROPERTIES:
:CUSTOM_ID: sec:data_taking:fadc_noise
:END:

FADC noise! Meant changing amplifier settings frequently. List those
changes for once. Show example of FADC noise. In (possibly noexport)
section show the peak finder thing to determine "noisiness".
...
** Plot of event durations recorded
