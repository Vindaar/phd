...
geometry was built as the small bore cannot expose more area. Further
the focal length was shortened to \SI{1.5}{m} and the the focal point
is slightly angled away from the straight continuation of the bore to
make more room for the installation of the detectors. This can be seen
in the render of the 2017/18 detector setup in fig. [[llnl_telescope_setup_2017_render]]

\cite{llnl_telescope_first_cast_results}
...
Have a distinct section about the best limits obtained. Good for
reference later. 
...
Mention the limit method with foreshadowing to statistics chapter that
