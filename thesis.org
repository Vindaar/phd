...
- [ ] *FIX UP THE TABLE TO NOT USE FIELDS AS ROW NAMES, BUT RATHER
  TEXT*
- [ ] *SEE NOEXPORT SECTION BELOW TO THINK ABOUT ADDING OTHER THINGS*  


*** Code to compute statistics [/]                               :noexport:
...
- [ ] total active tracking time 
- [ ] total # of events for each chip (non empty ones, & split between
     center & outside)
- [ ] fraction of events with only center / only outer chips  
- [ ] total # of FADC triggers
- [ ] total # of scintillator triggers (run 3, by scintillator)
- [ ] total # of non trivial scintillator triggers
