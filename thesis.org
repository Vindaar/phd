...
intensity of $I_0$. Directly related is of course the attenuation
length $l_{\text{abs}} = 1/μ$, which is a useful property when
considering typical absorption depths.
